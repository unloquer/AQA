...
#define NUM_LEDS 2
#define DI 4//D3 //4 // Si se usa la tarjeta wemos d1 mini se antepone la letra D a los pines
#define CI 2//D2 //2 // si se usa la roja de uber se unas los pines directamente
CRGB leds[NUM_LEDS];
